...
class Trader:
    """
    v9-R2: R1 v31 baseline + R2 mechanics + OSMIUM structural dislocation trading.
    ...
    R2 changes:
      ...
      - Hidden quote seed repair: if the official R2 80% randomizer hides one
        side of the very first PEPPER/OSMIUM book, seed fair value from the
        observed side plus/minus normal half-spread. This leaves public CSV
        behavior unchanged while avoiding a poisoned clock/anchor in official
        one-sided initial samples.
